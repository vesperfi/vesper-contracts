...
const StrategyConfig = {
  ...
  AaveV3_Vesper_Xy_CBETH_USDC: {
    ...
    constructorArgs: {
      ...
      strategyName: 'AaveV3_Vesper_Xy_CBETH_USDC',
    },
    config: { ...config }, // Shallow copy
    setup: { ...setup },
  },
  ...
  AaveV3_Sommelier_Xy_RETH_WETH: {
    contract: 'AaveV3SommelierXy',
    type: StrategyTypes.AAVE_V3_SOMMELIER_XY,
    constructorArgs: {
      swapper,
      receiptToken: Address.Aave.V3.aEthrETH,
      borrowToken: Address.WETH,
      aaveAddressProvider: Address.Aave.V3.AddressProvider,
      cellar: Address.Sommelier.YieldETH,
      strategyName: 'AaveV3_Sommelier_Xy_RETH_WETH',
    },
    config: { ...config }, // Shallow copy
    setup: { ...setup },
  },

  AaveV3_Sommelier_Xy_STETH_WETH: {
    contract: 'AaveV3SommelierStETH',
    type: StrategyTypes.AAVE_V3_SOMMELIER_XY,
    constructorArgs: {
      swapper,
      ...
      aaveAddressProvider: Address.Aave.V3.AddressProvider,
      cellar: Address.Sommelier.YieldETH,
      strategyName: 'AaveV3_Sommelier_Xy_STETH_WETH',
    },
    config: { ...config },
    setup: { ...setup },
  },

  AaveV3_Sommelier_Xy_WBTC_WETH: {
    contract: 'AaveV3SommelierXy',
    type: StrategyTypes.AAVE_V3_SOMMELIER_XY,
    constructorArgs: {
      swapper,
      ...
      aaveAddressProvider: Address.Aave.V3.AddressProvider,
      cellar: Address.Sommelier.YieldETH,
      strategyName: 'AaveV3_Sommelier_Xy_WBTC_WETH',
    },
    config: { ...config },
    setup: { ...setup },
  },
  ...
  AaveV3_Vesper_Xy_RETH_USDC: {
    ...
    constructorArgs: {
      ...
      aaveAddressProvider: Address.Aave.V3.AddressProvider,
      vPool: Address.Vesper.vaUSDC,
      strategyName: 'AaveV3_Vesper_Xy_RETH_USDC',
    },
    config: { ...config }, // Shallow copy
    setup: { ...setup },
  },
  ...
  Convex_eUSD_USDC: {
    ...
    type: StrategyTypes.CONVEX,
    constructorArgs: {
      crvPool: Address.Curve.eUSD_USDC_POOL,
      curvePoolType: CurvePoolTypes.DYNAMIC_ARRAYED_POOL,
      depositZap: ethers.constants.AddressZero,
      crvToken: Address.Curve.CRV,
      crvSlippage: 50, // 0.5%
      masterOracle,
  ...
  Convex_ynETHx_WETH: {
    ...
    type: StrategyTypes.CONVEX,
    constructorArgs: {
      crvPool: Address.Curve.ynETHx_ETH_POOL,
      curvePoolType: CurvePoolTypes.DYNAMIC_ARRAYED_POOL,
      depositZap: ethers.constants.AddressZero,
      crvToken: Address.Curve.CRV,
      crvSlippage: 50, // 0.5%
      ...
      collateralIdx: 1,
      convexPoolId: 418,
      strategyName: 'Convex_ynETHx_WETH',
    },
    config: { ...config },
    setup: { ...setup },
  },
  ...
  ConvexForFrax_DolaFraxPyusd_FRAX: {
    contract: 'ConvexForFrax',
    type: StrategyTypes.CONVEX_FOR_FRAX,
    constructorArgs: {
      crvPool: Address.Curve.DOLA_FRAXPYUSD_POOL,
      curvePoolType: CurvePoolTypes.DYNAMIC_ARRAYED_POOL,
      depositZap: Address.Curve.META_ZAP_NG,
      crvToken: Address.Curve.CRV,
      crvSlippage: 100, // 1%
      masterOracle,
      swapper,
      collateralIdx: 1,
      convexPoolId: 73,
      strategyName: 'ConvexForFrax_DolaFraxPyusd_FRAX',
    },
    config,
    setup,
  },
  ...
  Morpho_MetronomeMsUSD_Vault_msUSD: {
    contract: 'MorphoVault',
    type: StrategyTypes.MORPHO_VAULT,
    constructorArgs: {
      swapper,
