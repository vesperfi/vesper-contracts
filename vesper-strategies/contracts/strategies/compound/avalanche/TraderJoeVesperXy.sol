...
contract TraderJoeVesperXy is TraderJoeXy {
    ...
    constructor(
        ...
        address _vsp,
        string memory _name
    ) TraderJoeXy(_pool, _swapManager, _comptroller, _rewardToken, _receiptToken, _borrowCToken, _name) {
